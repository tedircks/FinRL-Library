...
class DRLAgent:
    ...
    def train_A2C(self, model_name, save, callback=None, model_params=config.A2C_PARAMS):
        """A2C model"""
        ...
        model.learn(callback=callback, total_timesteps=model_params['timesteps'], tb_log_name="A2C_run")
        end = time.time()
